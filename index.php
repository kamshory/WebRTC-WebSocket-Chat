...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="form.css?rand=<?php echo mt_rand(1, 99999999); ?>">
    ...
    <body>
        <div class="all">
            <div class="wrapper">
                <div class="sidebar">
                    <ul>
                        <li class=""><input type="button" class="btn" value="Logout" onclick="window.location='logout.php'"></li>
                    </ul>
        ...
        <div class="planet-video-call">
            <div class="video-call-popup"></div>
        </div>
